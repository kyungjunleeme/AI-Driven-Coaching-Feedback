...
def test_classifier_and_generator_roundtrip():
    chunks = [
        ...
        TranscriptChunk(id="t2", speaker="coach", text="좋아요. 다음엔 질문 뒤 2초 멈춤을 시도해봐요.")
    ]
    ...
    gi = GenerationInput(transcript_chunks=chunks, step_focus=StepEnum.LINK_PRAISE_TO_STUDENT_LEARNING)
