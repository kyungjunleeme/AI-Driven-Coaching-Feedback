...
def run_cloud_pipeline(audio_path: str, force_step: Optional[int] = None, language: str = "ko") -> Dict[str, Any]:
    ...
    try:
        ...
        s3_audio = None
    out_obj = {"session_id": session_id, "step_focus": step_focus, "transcript": transcript, "feedback": fb, "audio_s3": s3_audio}
    try:
